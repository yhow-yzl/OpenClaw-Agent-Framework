...
├─ Error/learning? → _learnings/LEARNINGS.md
...
- Corrected → `_learnings/LEARNINGS.md`
- **recurring ≥ 3** → Update `_learnings/PATTERNS.md`, propose system update (SOUL.md / AGENTS.md / TOOLS.md)
