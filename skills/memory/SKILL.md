...
Error/Correction → _learnings/LEARNINGS.md
Preference/Infra → MEMORY.md (P0)
```

### 4. Check Patterns

After writing to `_learnings/LEARNINGS.md`:
- If `recurring_count ≥ 3` → Update `_learnings/PATTERNS.md`, propose system update
...
- **_learnings/LEARNINGS.md** → Errors and corrections
- **_learnings/PATTERNS.md** → Recurring patterns (≥ 3 times)
